...
void World::LoadConfigSettings(bool reload)
{
    ...
    { {
        ...
        {.Name = "IngameShop.Enabled"sv, .DefaultValue = true, .Index = CONFIG_BATTLE_PAY_ENABLED },
        {.Name = "IngameShop.Enabled"sv, .DefaultValue = true, .Index = CONFIG_FEATURE_SYSTEM_BPAY_STORE_ENABLED },
        {.Name = "IngameShop.Enabled"sv, .DefaultValue = true, .Index = CONFIG_FEATURE_SYSTEM_BATTLE_PAY_AVAILABLE },
        {.Name = "BpayStore.Available"sv, .DefaultValue = true, .Index = CONFIG_BPAY_STORE_AVAILABLE },
        {.Name = "CommerceServer.Enabled"sv, .DefaultValue = true, .Index = CONFIG_COMMERCE_SERVER_ENABLED },
        {.Name = "ParentalControls.BpayStoreDisabled"sv, .DefaultValue = false, .Index = CONFIG_PARENTAL_CONTROLS_BPAY_STORE_DISABLED },
    ...
    { {
        ...
        { .Name = "IngameShop.Currency"sv, .DefaultValue = 1, .Index = CONFIG_BATTLE_PAY_CURRENCY },
    } };
